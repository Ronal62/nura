                                ...
                                <div class="card-body"> 
                                    <h3>Apakah Anda Ingin Menghapus Data Ini ? </h3>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="page/user/fungsi.php?act=hapus&id=<?=$r['id_user'];?>" type="submit" class="btn btn-primary">OK</a>
                                                </div>
                                </div>
                            </div><!-- end card-->
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="page/user/fungsi.php?act=edit" enctype="multipart/form_data" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" data-parsley-trigger="change" required class="form-control" id="emailAddress" value="<?= $r['password'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="pass1">Level<span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="example1" name="level">
                                            <?php if($r[level] == '1'){?>       
