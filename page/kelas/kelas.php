                                ...
                                <div class="card-body"> 
                                    <h3>Apakah Anda Ingin Menghapus Data Ini ? </h3>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="page/kelas/fungsi.php?act=hapus&id=<?=$r['id_kelas'];?>" type="submit" class="btn btn-primary">OK</a>
                                                </div>
                                </div>
                            </div><!-- end card-->
                        </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="page/kelas/fungsi.php?act=edit" enctype="multipart/form_data" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="pass1">Status<span class="text-danger">*</span></label>
                                            <select class="form-control select2" id="example1" name="status">
                                            <?php if($r[status] == 'Y'){?>       
